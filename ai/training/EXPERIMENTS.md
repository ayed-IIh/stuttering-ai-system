...
| baseline_seed7  | `configs/baseline_frozen.yaml` | planned | Reproducibility run using the same frozen baseline config with a different random seed tracked in run notes. | - |
